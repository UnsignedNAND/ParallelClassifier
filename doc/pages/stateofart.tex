...
\subsection{Data mining - Documents clusterization}
	\subsubsection{K-means algorithm} \label{k_means_algorithm}
...
\subsection{Data mining - Documents classification} \label{soa-classification}
	...
	\subsubsection{Support Vector Machine model} \label{soa-svm}
...
\begin{enumerate}
	...
	\item \textbf{False Negative Rate, Miss Rate, FNR} \label{FNR}
