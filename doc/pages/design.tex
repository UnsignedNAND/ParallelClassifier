...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1.0\linewidth]{images/diagrams/seq1.PNG}
		\caption{Sequence diagram, part 1}
		\label{design-sequence-diagram1}
	\end{center}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1.0\linewidth]{images/diagrams/seq2.PNG}
		\caption{Sequence diagram, part 2}
		\label{design-sequence-diagram2}
	\end{center}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1.0\linewidth]{images/diagrams/seq3.PNG}
		\caption{Sequence diagram, part 3}
		\label{design-sequence-diagram3}
	\end{center}
\end{figure}
