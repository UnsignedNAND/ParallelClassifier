...
Class diagram \ref{design-class-diagram} exposes implementation structure. Blocks were used to present classes and their internal methods and fields. Classes connected with association line communicate with each other either by passing values as parameters in function calls or by sending message objects using process-safe pipe/queue implementation. 
...
A short description of responsibilities of each class presented in diagram \ref{design-class-diagram} is shown below:
