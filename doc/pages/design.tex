...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1.0\linewidth]{images/diagrams/use-case/use-case-1.PNG}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1.0\linewidth]{images/diagrams/use-case/use-case-2.PNG}
		\caption{Example of ROC curve, source \cite{roc-curve}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=1.0\linewidth]{images/diagrams/use-case/use-case-3.PNG}
		\caption{Example of ROC curve, source \cite{roc-curve}}
		\label{design-use-case-3}
	\end{center}
\end{figure}
